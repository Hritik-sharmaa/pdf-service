...
const QuoteDataSchema = z.object({
  ...
  visaPriceAdult: z.number().nullable().optional(),
  visaPriceChild: z.number().nullable().optional(),
  visaPriceInfant: z.number().nullable().optional(),
  ...
  highlightsHtml: z.string().nullable().optional(),
